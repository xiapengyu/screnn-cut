...
INSERT INTO `sys_menu` VALUES ('43', '0', '运营管理', '', '', '0', 'job', '1');
INSERT INTO `sys_menu` VALUES ('44', '43', '充值记录', '暂未开发', 'opreation:recharge:list', '1', 'menu', '1');
INSERT INTO `sys_menu` VALUES ('45', '43', '赠送规则列表', '暂未开发', 'donaterule:list', '1', 'menu', '1');
INSERT INTO `sys_menu` VALUES ('46', '43', '赠送记录', '暂未开发', 'donaterecode:list', '1', 'menu', '1');
INSERT INTO `sys_menu` VALUES ('47', '0', '商品管理', '暂未开发', 'commodity:list', '1', 'menu', '2');
INSERT INTO `sys_menu` VALUES ('49', '0', '会员管理', '暂未开发', 'member:list', '1', 'menu', '4');
INSERT INTO `sys_menu` VALUES ('50', '0', '统计报表', '', '', '0', 'menu', '5');
INSERT INTO `sys_menu` VALUES ('51', '50', '订单报表', '暂未开发', 'report:list', '1', 'menu', '6');
INSERT INTO `sys_menu` VALUES ('52', '50', '充值账单', 'sys/rechargeReport', 'rechargebill:list', '1', 'menu', '1');
INSERT INTO `sys_menu` VALUES ('53', '0', '设备管理', '', '', '0', 'menu', '7');
INSERT INTO `sys_menu` VALUES ('54', '53', '设备列表', '暂未开发', 'device:list', '1', 'menu', '0');
INSERT INTO `sys_menu` VALUES ('55', '53', '设备地图', '暂未开发', 'devicemap:list', '1', 'menu', '1');
INSERT INTO `sys_menu` VALUES ('56', '53', '预警管理', '暂未开发', 'deviceworn:list', '1', 'menu', '2');
INSERT INTO `sys_menu` VALUES ('64', '0', '系统日志', '暂未开发', 'syslog:list', '1', 'menu', '12');
INSERT INTO `sys_menu` VALUES ('65', '0', '广告管理', '暂未开发', 'ad:list', '1', 'menu', '13');
...
-- ----------------------------
INSERT INTO `sys_user_token` VALUES ('1', '852d759b570cd7b0c2a83c7baf4dc58b', '2020-01-21 05:33:04', '2020-01-20 17:33:04');
...
CREATE TABLE `tb_account` (
  ...
  `delete_flag` int(2) NOT NULL DEFAULT '1' COMMENT '删除标记',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `tb_account` VALUES ('1', '635642897@qq.com', '9dc63b007f7dc2ef6aae087920277c92', '', 'IMEI20109059', '2020-01-22 09:11:46', '2020-01-22 09:11:46', '1');
