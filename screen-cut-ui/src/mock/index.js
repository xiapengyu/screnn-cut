...
import * as appUser from './modules/sys-appUser'
import * as sysGoodsAdd from './modules/sys-goodsAdd'
import * as sysGoodsList from './modules/sys-goodsList'
import * as sysPerson from './modules/sys-person'
...
fnCreate(appUser, false)
fnCreate(sysGoodsAdd, false)
fnCreate(sysGoodsList, false)
fnCreate(sysPerson, false)
